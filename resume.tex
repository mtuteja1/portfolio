...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Development of a fully autonomous 6-DOF robot for pick and place samples using Beckhoff \textbf{PLC} for use in a laboratory environment.}
        ...
        \resumeItem{Developed pneumatics circuitry integrating vacuum systems, solenoid valves, regulators, gauges, and peristaltic pumps.}
        \resumeItem{Developed electrical circuitry incorporating power supplies, circuit breakers, switches, and relays.}
      \resumeItemListEnd
    \resumeSubheading
