...
\usepackage{verbatim}
\usepackage{enumitem}
\usepackage[colorlinks=true, urlcolor=MidnightBlue, linkcolor=MidnightBlue, citecolor=MidnightBlue]{hyperref}
\usepackage{fancyhdr}
...
\newcommand{\resumeLink}[2]{\href{#1}{\textcolor{black}{\underline{#2}}}}
...
\begin{center}
  ...
  \small 424-392-0891 $|$ \resumeLink{mailto:manan.tuteja5@gmail.com}{manan.tuteja5@gmail.com} $|$ 
  \resumeLink{https://www.linkedin.com/in/manan-tuteja-8042b0396/}{linkedin.com/in/MananTuteja} $|$
  \resumeLink{https://mtuteja1.github.io/portfolio/}{Portfolio}
\end{center}

% About Me
\section{Summary}
    \textnormal
    {Graduate Mechanical Engineering student specializing in robotic design and control systems. Experience bridging mechanical and electrical CAD, with practical programming skills.}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Integrated proximity sensors, ultrasonic level sensors, and \textbf{stepper motor} control across both hardware and PLC software.}
      \resumeItemListEnd
    \resumeSubheading
      {\resumeLink{https://tritonrobotics.org/}{Triton Robotics} @ University of California San Diego}{Jan. 2024 -- Present}
      {President / Vice President Mechanical Team}{Jul. 2025 -- Present}
      \resumeItemListStart
        \resumeItem{Autonomous Robot developed for \resumeLink{https://www.robomasterna.com/}{ARC Robotics Competition} with computer vision based turret system.}
    ...
    \resumeMyPosition{Mechanical Team Member}{Jan. 2024 -- Jun. 2025}
      ...
      \resumeItemListEnd
    \resumeSubheading{\resumeLink{https://cad.onshape.com/documents/8d7a194dfe5029fbce6673fb/w/743d9750d0b0d0938b222467/e/45413dfaad445ade4001fb03}{RC Airplane} (Custom Project)}{Mar. 2026 -- Jun. 2026}{}{}
    \vspace{-17pt}
      \resumeItemListStart
        \resumeItem{Designed a custom RC airplane targeting a 3.5 lb payload and 5 minute flight time.}
        \resumeItem{Applied \textbf{design for manufacturing} with laser-cut \textbf{T-slot} and tab joints, plus 3-D printed parts such as a PLA nose cone for fast iteration.}
        \resumeItem{Built the lifting surface structures with an epoxy-bonded \textbf{carbon-fiber reinforced spar}, \textbf{balsa reinforced foam}, and Monokote skin for a smooth finish.}
        \resumeItem{Designed, programmed, and tested payload door servos and IMU integration for flight functionality.}
      \resumeItemListEnd
...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
      \resumeItem{Cumulative GPA: 3.818, Major GPA: 3.750}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
%SKILLS
